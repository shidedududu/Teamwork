        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <td>
                        <a href="/admin/user/show/${user.userName}" type="button" class="btn btn-sm btn-success">详情</a>
                        <a href="/admin/user/update/${user.userName}" type="button" class="btn btn-sm btn-warning">修改</a>
                        <a href="/admin/user/delete/${user.userName}" type="button" class="btn btn-sm btn-danger">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
